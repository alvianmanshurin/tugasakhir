"""
Script uji coba deteksi dengan ROI yang sudah di-adjust (tanpa jarak, dengan ID)
"""
import cv2
import sys
...
cv2.rectangle(result_img, (0, 0), (500, 120), (0, 0, 0), -1)
cv2.putText(result_img, f'ROI BARU | Deteksi: {len(detections)} | Dalam ROI: {len(filtered)}',
...
output_path = 'data/test_detection_roi_adjusted.jpg'
